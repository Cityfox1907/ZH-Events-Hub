...
export const DEMO_PROFILES: Record<ProfileKey, DemoProfile> = {
  fiko: {
    key: "fiko",
    name: "Fiko",
    short: "Lokal · Kreis 11",
    district: "Kreis 11 · Oerlikon",
    interests: ["Konzerte", "Italienisch", "Stadt-Politik"],
  ...
  sarah: {
    ...
    name: "Sarah",
    short: "Expat · Kreis 5",
    district: "Kreis 5 · Industriequartier",
    interests: ["Brunch", "Sprach-Tandems", "Run-Clubs"],
    bookmarks: { events: 3, places: 5 },
    available: true,
  },
  tom: {
    key: "tom",
    name: "Tom",
    short: "Tourist · 4 Tage",
    district: "Hotel Storchen · Kreis 1",
    interests: ["Sehenswürdigkeiten", "Restaurants", "Souvenirs"],
    bookmarks: { events: 2, places: 4 },
    available: true,
  },
};
